...
FILE_DESCRIPTION = "Battlezone Workshop Uploader"
INTERNAL_NAME = "BZWorkshopUploader"
ORIGINAL_FILENAME = "BZWorkshopUploader.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 1.6 or v1.6")
